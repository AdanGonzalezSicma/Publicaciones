<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Iniciar-Sesion-Alumnos.aspx.cs" Inherits="Sistema_web.Cuenta.Iniciar_Sesion_Alumnos" %>
        ...
        <div class="col-sm-6 login-section-wrapper ">
          ...
          <div class="login-wrapper" >
            ...
            <form id="form1" runat="server">
                ...
                <label for="Club">Código del Club</label>
                   <asp:TextBox ID="txtCodigoClub" runat="server" Width="100%" class="form-control" placeholder="Ingrese el Código del Club" CssClass="form-control" required></asp:TextBox>
              ...
              <div class="form-group mb-4">
                ...
                <asp:LinkButton ID="lbtnIniciarSesion" runat="server" class="btn btn-block login-btn" OnClick="lbtnIniciarSesion_Click" Onclientclick="MostarDistractor()">Iniciar Sesión</asp:LinkButton>
