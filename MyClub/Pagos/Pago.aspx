<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pago.aspx.cs" Inherits="Sistema_web.Pagos.Pago" %>
    ...
    <div id="form1" runat="server">
        ...
        <div class="page">
            ...
            <section class="section section-intro context-dark">
                <div class="intro-bg" style="background: url(/Content/images/pago.png) no-repeat; background-size: cover; background-position: top center; height: 300px"></div>
                                ...
                                <div class="row">
                                    <div class="col-lg-8 col-sm-8">
                                        <div class="form-check">
                                            <input type="radio" checked="checked" class="form-check-input" id="radio1" name="optradio" value="option1" /><b>Tarjeta de Crédito/Débito</b>
                        ...
                        <div class="card" style="width: 100%">
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    <asp:Image ID="imgLogo" runat="server"  style="width: 50%"/>
                                </div>

                                <h5 class="card-title"><b>
                                    <asp:Label ID="lblNombreClubDeportivo" runat="server" Text="Label"></asp:Label></b></h5>
                                <p class="card-text">
