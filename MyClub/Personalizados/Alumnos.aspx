<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Alumnos.aspx.cs" Inherits="Sistema_web.Personalizados.Alumnos" %>
...
<AdaptiveDetailLayoutProperties ColCount="1"></AdaptiveDetailLayoutProperties>
        ...
        <Columns>
            ...
            <dx:GridViewDataDateColumn FieldName="FechaAlta" VisibleIndex="6"></dx:GridViewDataDateColumn>
            <dx:GridViewDataDateColumn FieldName="FechaUltimoCargo" VisibleIndex="7" Caption="&#218;lt. Cargo"></dx:GridViewDataDateColumn>
            <dx:GridViewDataDateColumn FieldName="FechaUltimaAsistencia" VisibleIndex="8" Caption="&#218;lt. Asistencia"></dx:GridViewDataDateColumn>
            <dx:GridViewDataCheckColumn FieldName="Activo" VisibleIndex="9"></dx:GridViewDataCheckColumn>
            <dx:GridViewDataTextColumn FieldName="MontoDescuentoAutorizado" VisibleIndex="10" Visible="False"></dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="UsuarioDescuento" VisibleIndex="11" Visible="False"></dx:GridViewDataTextColumn>
            <dx:GridViewDataCheckColumn FieldName="Suspendido" VisibleIndex="12" Visible="False"></dx:GridViewDataCheckColumn>
            <dx:GridViewDataDateColumn FieldName="FechaSuspension" VisibleIndex="13" Visible="False"></dx:GridViewDataDateColumn>
            <dx:GridViewDataCheckColumn FieldName="UsuarioSuspension" VisibleIndex="14" Visible="False"></dx:GridViewDataCheckColumn>
            <dx:GridViewDataTextColumn FieldName="MotivoSuspension" VisibleIndex="15" Visible="False"></dx:GridViewDataTextColumn>
            <dx:GridViewDataCheckColumn FieldName="Baja" VisibleIndex="16" Visible="False"></dx:GridViewDataCheckColumn>
            <dx:GridViewDataDateColumn FieldName="FechaBaja" VisibleIndex="17" Visible="False"></dx:GridViewDataDateColumn>
            <dx:GridViewDataTextColumn FieldName="UsuarioBaja" VisibleIndex="18" Visible="False"></dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="MotivoBaja" VisibleIndex="19" Visible="False"></dx:GridViewDataTextColumn>
    ...
    <asp:SqlDataSource runat="server" ID="SqlDSAlumnosPersonalizados" ConnectionString='<%$ ConnectionStrings:MyClubConnectionString %>' SelectCommand="SELECT [Oid], [OidClub], [OidAlumno], [OidPersonalizado], [NumeroControlAsistencua], [FechaRegistro], [FechaAlta], [FechaUltimoCargo], [FechaUltimaAsistencia], [Activo], [MontoDescuentoAutorizado], [UsuarioDescuento], [Suspendido], [FechaSuspension], [UsuarioSuspension], [MotivoSuspension], [Baja], [FechaBaja], [UsuarioBaja], [MotivoBaja] FROM [ClubPersonalizadosAlumnos] WHERE ([OidClub] = @OidClub)" InsertCommand="INSERT INTO [dbo].[ClubPersonalizadosAlumnos]
           ([OidClub]
           ,[OidAlumno]
           ,[OidPersonalizado]
