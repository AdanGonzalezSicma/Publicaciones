<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Indicaciones-2.aspx.cs" Inherits="CreandoProductividad.Sensibilizacion.Indicaciones_2" %>
                        ...
                        <div class="col-md-12 col-12 col-sm-12 col-lg-12">
                            <div class="card" style="border: none">
                                <div class="card-body" style=" text-transform:none">
                                    <h3 style=" text-transform:none" id="titulo">Orientaciones para facilitar este curso</h3>
                                    <div class="row">
                                        <div class="col-lg-6 mx-auto text-left">
                                            <article>
                                                <div>
                                                    <h4 style=" text-transform:none">
                                                        <b>2. Tendrás 2 oportunidades para hacerlo, dentro de 7 días hábiles.</b>
                                                    </h4>
                                                    <h4 style=" text-transform:none">
                                                        <b>3. Se sugiere que estés tranquilo y en un lugar cómodo.</b>
                                                    </h4>
                                                    <h4 style=" text-transform:none">
                                                        <b>4. Al cierre de cada tema obtendrás una retroalimentación.</b>
                                                    </h4>
                                                </div>
                                            </article>
                                            <br>
                                        ...
                                        <div class="col-lg-4 mx-auto text-left ">
                                            <article>
                                                <img src="Videos/indicaciones.png" style="width:100%" />                                              
                                            </article>
                                            <br>
                                        </div>
                                    </div>
            ...
            <div class="container-fluid">
                <div class="footer-minimal-inset oh">
                    <div class="row" id="botones">
                        ...
                        <div class="col-md-6  col-sm-12 col-lg-6 text-center">
                            <asp:Button class="button button-primary button-ujarak" data-caption-animate="fadeInUp" data-caption-delay="200" Style="margin: 5px" Text="Siguiente" runat="server" OnClick="Unnamed_Click" />
        <%--                    <a class="button button-primary button-ujarak" href="Sensibilizacion-inicio.aspx"
