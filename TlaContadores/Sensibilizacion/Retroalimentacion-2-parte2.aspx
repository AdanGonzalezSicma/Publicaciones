<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Retroalimentacion-2-parte2.aspx.cs" Inherits="CreandoProductividad.Sensibilizacion.Retroalimentacion_2_parte2" %>
                                            ...
                                            <article>
                                                <div>
                                                    ...
                                                    <h4 style="font-size:20px">
                                                        <b>4. Selecciona ¿Cuál de estas dos opciones son obligaciones del Patrón en la NOM-035?</b>
                                                    </h4>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="radio" id="rbtn1" title="Contratar a un Médico y Psicólogo de planta en la empresa." class="form-check-input" name="rbtnPregunta1">
                                                            <b>Contratar a un Médico y Psicólogo de planta en la empresa.</b>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="radio" id="rbtn2" title="Identificar a los trabajadores que fueron sujetos a acontecimientos traumáticos severos durante o con motivo del trabajo, Practicar exámenes médicos y evaluaciones psicológicas a los trabajadores expuestos a violencia laboral y/o a los factores de riesgo psicosocial y difundir y proporcionar información a los trabajadores y llevar los Registros." class="form-check-input" name="rbtnPregunta1">
                                                            <b>Identificar a los trabajadores que fueron sujetos a acontecimientos traumáticos severos durante o con motivo del trabajo, Practicar exámenes médicos y evaluaciones psicológicas a los trabajadores expuestos a violencia laboral y/o a los factores de riesgo psicosocial y difundir y proporcionar información a los trabajadores y llevar los Registros.</b>
                                                        </label>
                                                    </div>
                                                </div>
                                            </article>
                                        ...
                                        <div class="col-lg-4 mx-auto text-left ">
                                            <article>
                                                <div>
                                                    <!-- PREGUNTA #2 -->
                                                    <h4 style="font-size:20px">
                                                        <b>5. Para implementar la NOM-035 ¿el trabajador también tiene obligaciones?</b>
                                                    </h4>
                                        ...
                                        <div class="col-lg-4 mx-auto text-left ">
                                            <article>
                                                <div>
                                                    <!-- PREGUNTA #3 -->
                                                    <h4 style="font-size:20px">
                                                        <b>6. ¿Cuál es la obligación del trabajador, en caso de sufrir un Acontecimiento traumático severo?</b>
                                                    </h4>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="radio" id="rbtn5" title="Informar por escrito al patrón directamente, haber presenciado o sufrido un acontecimiento traumático severo." class="form-check-input" name="rbtnPregunta3">
                                                            <b>Informar por escrito al patrón directamente, haber presenciado o sufrido un acontecimiento traumático severo.</b>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="radio" id="rbtn6" title="Observa y Colabora con las medidas y acciones preventivas dispuestas por la norma y el Patrón." class="form-check-input" name="rbtnPregunta3">
                                                            <b>Observa y Colabora con las medidas y acciones preventivas dispuestas por la norma y el Patrón.</b>
                                                        </label>
                                                    </div>
                                                </div>
                                            </article>
          ...
          <div class="footer-minimal-inset oh">
             <div class="row" id="botones">
                ...
                <div class="col-md-6  col-sm-12 col-lg-6 text-center">
                    <a class="button button-primary button-ujarak" href="Retroalimentacion-2.aspx" data-caption-animate="fadeInUp" data-caption-delay="200" style="margin:5px">Regresar</a> 
                </div>
