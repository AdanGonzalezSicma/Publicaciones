<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Retroalimentacion-1-Parte3.aspx.cs" Inherits="CreandoProductividad.Sensibilizacion.Retroalimentacion_1_Parte3" %>
...
<body  style="background-position: 100%; background-repeat: no-repeat; background-size: cover; background-image:url(../images/banner/Sensibilizacion/retroalimentacion.png)">
                        ...
                        <div class="col-md-12 col-12 col-sm-12 col-lg-12">
                            <div class="card" style="border: none; background-color:transparent; padding-top:1px">
                                <div class="card-body" style=" padding-top:1px">
                                   <h3 style="font-size:30px!important" id="titulo">I Retroalimentación parte 3</h3>
                                            ...
                                            <article>
                                                <div>
                                                    ...
                                                    <h4 style="font-size:20px">
                                                        <b>7. ¿Qué es Violencia Laboral?</b>
                                                    </h4>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="radio" id="rbtn1" title="Consecuencias de los malos entendidos al recibir instrucciones del trabajo" class="form-check-input" name="rbtnPregunta1">
                                                            <b>Consecuencias de los malos entendidos al recibir instrucciones del trabajo</b>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="radio" id="rbtn2" title="Situación en la que un trabajador o grupo de trabajadores realizan una serie de acciones violentas psicológicas de forma sistemática en contra de otro u otros trabajadores." class="form-check-input" name="rbtnPregunta1">
                                                            <b>Situación en la que un trabajador o grupo de trabajadores realizan una serie de acciones violentas psicológicas de forma sistemática en contra de otro u otros trabajadores.</b>
                                                        </label>
                                                    </div>
                                        ...
                                        <div class="col-lg-4 mx-auto text-left ">
                                            <article>
                                                <div>
                                                    <!-- PREGUNTA 2 -->
                                                    <h4 style="font-size:20px">
                                                        <b>8. ¿Qué es Mobbing?</b>
                                                    </h4>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="radio" id="rbtn3" title="Son conductas verbales, físicas o ambas, relacionadas con la sexualidad de connotación lasciva." class="form-check-input" name="rbtnPregunta2">
                                                            <b>Son conductas verbales, físicas o ambas, relacionadas con la sexualidad de connotación lasciva.</b>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="radio" id="rbtn4" title="Es una forma de violencia laboral, consiste en el trato hostil al que es sometida una persona en el ámbito laboral de forma sistemática, que le provoca problemas psicológicos y profesionales" class="form-check-input" name="rbtnPregunta2">
                                                            <b>Es una forma de violencia laboral, consiste en el trato hostil al que es sometida una persona en el ámbito laboral de forma sistemática, que le provoca problemas psicológicos y profesionales</b>
                                                        </label>
                                                    </div>
          ...
          <div class="footer-minimal-inset oh">
             <div class="row" id="botones">
                ...
                <div class="col-md-6  col-sm-12 col-lg-6 text-center">
                    <a class="button button-primary button-ujarak" href="Retroalimentacion-1-Parte2.aspx" data-caption-animate="fadeInUp" data-caption-delay="200" style="margin:5px">Regresar</a> 
                </div>
    ...
    <script type="text/javascript">
        ...
        function fncValidarRespuestas() {
            ...
            if (rbtn2 == "Situación en la que un trabajador o grupo de trabajadores realizan una serie de acciones violentas psicológicas de forma sistemática en contra de otro u otros trabajadores." &&
                rbtn4 == "Es una forma de violencia laboral, consiste en el trato hostil al que es sometida una persona en el ámbito laboral de forma sistemática, que le provoca problemas psicológicos y profesionales") {
