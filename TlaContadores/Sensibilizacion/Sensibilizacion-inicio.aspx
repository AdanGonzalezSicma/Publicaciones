<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sensibilizacion-inicio.aspx.cs" Inherits="CreandoProductividad.Sensibilizacion.Sensibilizacion_inicio" %>
                                ...
                                <div class="card-body">
                                    <%--<br />
                                     <video id="video"> <!-- poster="Videos/Vistaprevia.jpeg" -->
                                        <source src="Videos/1RA-PARTE-VIDEO-CURSO-SENS-PARA-TODOS.mp4" type="video/mp4" />
                                        <!-- Lo sentimos. Este vídeo no puede ser reproducido en tu navegador.<br>
                                        La versión descargable está disponible en <a href="URL">Enlace</a>. -->
                                    </video>--%>
                                    <iframe id="video" src="https://player.vimeo.com/video/473259269" width="640" height="564" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
