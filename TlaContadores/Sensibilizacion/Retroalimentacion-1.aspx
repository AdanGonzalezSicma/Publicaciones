<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Retroalimentacion-1.aspx.cs" Inherits="CreandoProductividad.Sensibilizacion.Retroalimentacion_1" %>
                        ...
                        <div class="col-md-12 col-12 col-sm-12 col-lg-12">
                            <div class="card" style="border: none; background-color:transparent; padding-top:1px">
                                <div class="card-body" style="padding-top:1px">
                                   <h3 id="titulo">I Retroalimentación</h3>
                                    ...
                                    <div class="row">
                                            ...
                                            <article>
                                                <div>
                                                    ...
                                                    <h4 style="font-size:20px">
                                                        <b>1.	Sobre el Objetivo de la NOM-035</b>
                                                    </h4>

                                                    <!-- PREGUNTA #1 -->
                                                    <p style="font-size:18px"><b>¿Qué previene la NOM 035?</b></p>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="radio" id="rbtn1" title="El desperdicio de material en las líneas de producción" class="form-check-input" name="rbtnPregunta1">
                                                            <b>El desperdicio de material en las líneas de producción</b>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="radio" id="rbtn2" title="Los Factores de Riesgo Psicosocial" class="form-check-input" name="rbtnPregunta1">
                                                            <b>Los Factores de Riesgo Psicosocial</b>
                                                        </label>
                                                    </div>

                                                    <!-- PREGUNTA #2 -->
                                                    <p style="font-size:18px"><b>¿Qué promueve la NOM 035?</b></p>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="radio" id="rbtn3" title="Los Factores de Riesgo Psicosocial" class="form-check-input" name="rbtnPregunta2">
                                                            <b>Los Factores de Riesgo Psicosocial</b>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="radio" id="rbtn4" title="Entorno Organizacional Favorable en los centros de trabajo." class="form-check-input" name="rbtnPregunta2">
                                                            <b>Entorno Organizacional Favorable en los centros de trabajo.</b>
                                                        </label>
                                                    </div>
                                                </div>
                                            </article>
                                        ...
                                        <div class="col-lg-4 mx-auto text-left ">
                                            <article>
                                                <div>
                                                    <!-- SECCION #2 -->
                                                    <h4 style="font-size:20px">
                                                        <b>2. Para la correcta interpretación y aplicación de la NOM-035, ¿Qué otras normas oficiales mexicanas se deben consultar?</b>
                                                    </h4>

                                                    <!-- RESPUESTAS DE SECCION #2 -->
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="radio" id="rbtn5" title="NOM-019, NOM-030 y NMX-R-025" class="form-check-input" name="rbtnPregunta3">
                                                            <b>NOM-019, NOM-030 y NMX-R-025</b>
                                                        </label>
                                                    </div>

                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="radio" id="rbtn6" title="NOM-029, NOM-001 Y NOM-002" class="form-check-input" name="rbtnPregunta3">
                                                            <b>NOM-029, NOM-001 Y NOM-002</b>
                                                        </label>
                                                    </div>
                                        ...
                                        <div class="col-lg-4 mx-auto text-left ">
                                            <article>
                                                <div>
                                                    <!-- SECCION #3 -->
                                                    <h4 style="font-size:20px"><b>3.	¿Cuál es su campo de aplicación?</b>
                                                    </h4>

                                                    <!-- RESPUESTAS -->
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="radio" id="rbtn7" title="Sólo en empresas de 51 trabajadores o más." class="form-check-input" name="rbtnPregunta4">
                                                            <b>Sólo en empresas de 51 trabajadores o más.</b>
                                                        </label>
                                                    </div>

                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="radio" id="rbtn8" title="En todos los centros de trabajo de toda la república mexicana." class="form-check-input" name="rbtnPregunta4">
                                                            <b> En todos los centros de trabajo de toda la república mexicana.</b>
                                                        </label>
                                                    </div>
...
<br />
          ...
          <div class="footer-minimal-inset oh">
             <div class="row" id="botones">
                ...
                <div class="col-md-6  col-sm-12 col-lg-6 text-center">
                    <!--<a class="button button-primary button-ujarak" href="Sensibilizacion-inicio.aspx" data-caption-animate="fadeInUp" data-caption-delay="200" style="margin:5px">Regresar</a> -->
                </div>
    ...
    <script type="text/javascript">
        ...
        function fncValidarRespuestas() {
            ...
            var rbtn2 = $("input[name=rbtnPregunta2]:checked", "#myForm").attr("title");
            var rbtn3 = $("input[name=rbtnPregunta3]:checked", "#myForm").attr("title");
            var rbtn4 = $("input[name=rbtnPregunta4]:checked", "#myForm").attr("title");

            if (rbtn1 == "Los Factores de Riesgo Psicosocial" &&
                rbtn2 == "Entorno Organizacional Favorable en los centros de trabajo." &&
                rbtn3 == "NOM-019, NOM-030 y NMX-R-025" &&
                rbtn4 == "En todos los centros de trabajo de toda la república mexicana.") {
