<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Indicaciones.aspx.cs" Inherits="CreandoProductividad.Sensibilizacion.Indicaciones" %>
                        ...
                        <div class="col-md-12 col-12 col-sm-12 col-lg-12">
                            <div class="card" style="border: none">
                                <div class="card-body" style=" text-transform:none">
                                    <h3 style=" text-transform:none" id="titulo">1.-Puedes utilizar cualquier dispositivo móvil, que cuente con:</h3>
                                    <div class="row">
                                        <div class="col-lg-6 mx-auto text-left">
                                            <article>
                                                <div>
                                                    ...
                                                    <p style="font-size:18px">El curso está desarrollado para pantallas con las siguientes resoluciones: 1920x1080, 1600x900 y 1366x768.</p>                                                   
                                                   
                                                    <p style="font-size:18px">El texto siempre debe estar al 100%, ya que de otra manera, si el porcentaje crece, es probable que se distorsione el contenido y sea más difícil de llevarse a cabo.</p>
                                                 </div>
                                            </article>
                                        ...
                                        <div class="col-lg-5 mx-auto text-center ">
                                            <article>
                                                <h4 >
                                                    <b>Los Siguientes navegadores:</b>
                                                </h4>
                                                <img src="Videos/Navegadores.jpeg" style="width:100%" />
                                            </article>
                                            <br>
                                        </div>
                                    </div>
                ...
                <div class="footer-minimal-inset oh">
                    <div class="row" id="botones">
                        <div class="col-md-6  col-sm-12 col-lg-6 text-center">
                            <a class="button button-primary button-ujarak" href="Bienvenido.aspx"
                               data-caption-animate="fadeInUp" data-caption-delay="200" style="margin:5px">Regresar</a>
                        </div>
                        <div class="col-md-6  col-sm-12 col-lg-6 text-center">
                            <a class="button button-primary button-ujarak" href="Indicaciones-2.aspx"
                               data-caption-animate="fadeInUp" data-caption-delay="200" style="margin:5px">Siguiente</a>
                        </div>
                    </div>
                </div>
            </div>
