<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NOMEncuestasGuias.aspx.cs" Inherits="CreandoProductividad.Catalogos.NOMEncuestasGuias" %>
<%@ Register Assembly="DevExpress.Web.v18.1, Version=18.1.4.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server"></asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <dx:ASPxHiddenField ID="hiddenGuiaID" ClientInstanceName="hiddenGuiaID" runat="server"></dx:ASPxHiddenField>
    ...
    <script>
        ...
        function OnToolbarItemClick(s, e) {
            if (e.item.name == "EliminarGuia") {
                visibleIndex = gridGuias.GetFocusedRowIndex();
                gridGuias.GetRowValues(visibleIndex, 'OIDGuia;Activo', fncEliminarGuia);
            }
        }

        function fncEliminarGuia(value) {
            var OIDGuia = value[0];

            if (OIDGuia != 0) {
                hiddenGuiaID.Set("OIDGuia", OIDGuia);
                PopupEliminarGuia.Show();
            } else {
                PopupError.Show();
            }
        }
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 class="m-0" style=" padding-top:15px;"><b>Guías</b></h3>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right" style=" padding-top:15px">
              ...
              <li class="breadcrumb-item active"  style="color:white">Guías</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <dx:ASPxGridView
        ID="gridGuias"
        ClientInstanceName="gridGuias"
        runat="server"
        AutoGenerateColumns="False"
        DataSourceID="SqlDSGuias"
        KeyFieldName="OIDGuia"
        Width="100%" 
        OnInitNewRow="gridGuias_InitNewRow">
        ...
        <EditFormLayoutProperties ColCount="4" ColumnCount="4">
            <Items>
                <dx:GridViewColumnLayoutItem ColumnName="Nombre" ColSpan="4" ColumnSpan="4"></dx:GridViewColumnLayoutItem>
        ...
        <Columns>
            <dx:GridViewDataTextColumn VisibleIndex="0" FieldName="OIDGuia" ReadOnly="True" Caption="OIDGuia" Visible="False">
            ...
            <dx:GridViewDataTextColumn FieldName="Nombre" VisibleIndex="1">
                <PropertiesTextEdit MaxLength="50">
                    <ValidationSettings ErrorDisplayMode="ImageWithTooltip" ErrorTextPosition="Right" RequiredField-IsRequired="true" 
                                        RequiredField-ErrorText="Ingresar guía." ValidateOnLeave="true" SetFocusOnError="true">
                        <RequiredField IsRequired="True" ErrorText="Ingresar guía."></RequiredField>
                    </ValidationSettings>
                </PropertiesTextEdit>
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataCheckColumn FieldName="Activo" VisibleIndex="3"></dx:GridViewDataCheckColumn>
            <dx:GridViewDataMemoColumn FieldName="Descripcion" Caption="Descripci&#243;n" VisibleIndex="2">
                <PropertiesMemoEdit MaxLength="200" Rows="5"></PropertiesMemoEdit>
            ...
            <dx:GridViewToolbar ItemAlign="Right">
                <Items>
                    <dx:GridViewToolbarItem Text="Nuevo" Command="New" BeginGroup="True">
                        ...
                        <ItemStyle Border-BorderColor="Navy" Border-BorderStyle="Solid" BackColor="Navy" ForeColor="White" HorizontalAlign="Right" >
                    ...
                    <dx:GridViewToolbarItem Text="Eliminar" Name="EliminarGuia" BeginGroup="True">
    ...
    <!-- POPUP ELIMINAR -->
    <dx:ASPxPopupControl
        ID="PopupEliminarGuia"
        ClientInstanceName="PopupEliminarGuia"
        runat="server"
        Modal="True"
        ...
        <ContentCollection>
            <dx:PopupControlContentControl>
                ...
                <div class="text-right">
                    <dx:ASPxButton ID="btnEliminarGuia" OnClick="btnEliminarGuia_Click" runat="server" Text="Eliminar" BackColor="#FF3547" CssClass="btn-danger">
                    ...
                    <dx:ASPxButton ID="btnCerrarEliminar" runat="server" Text="Cancelar" AutoPostBack="false" BackColor="White" ForeColor="#FF3547" CssClass="btn-danger">
                        <ClientSideEvents Click="function (s, e) { PopupEliminarGuia.Hide(); }" />
                        <Border BorderColor="#FF3547" BorderStyle="Solid" BorderWidth="3px" />
                    </dx:ASPxButton>
                </div>
            </dx:PopupControlContentControl>
    ...
    <!-- SQLDS GUIAS -->
    <asp:SqlDataSource ID="SqlDSGuias" runat="server" ConnectionString='<%$ ConnectionStrings:NOM035ConnectionString %>' SelectCommand="spListadoNOMEncuestasGuias"
        InsertCommand="spCrearNOMEncuestasGuias"
        UpdateCommand="spActualizarNOMEncuestasGuias" InsertCommandType="StoredProcedure" SelectCommandType="StoredProcedure" UpdateCommandType="StoredProcedure">
        <InsertParameters>
        ...
        <UpdateParameters>
            ...
            <asp:Parameter Name="Descripcion" Type="String"></asp:Parameter>
            <asp:Parameter Name="Activo"></asp:Parameter>
            <asp:Parameter Name="OIDGuia" Type="Int64"></asp:Parameter>
        </UpdateParameters>
    </asp:SqlDataSource>
