<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NOMEncuestasDimensiones.aspx.cs" Inherits="CreandoProductividad.Catalogos.NOMEncuestasDimensiones" %>
<%@ Register Assembly="DevExpress.Web.v18.1, Version=18.1.4.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server"></asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <dx:ASPxHiddenField ID="hiddenDimensionID" ClientInstanceName="hiddenDimensionID" runat="server"></dx:ASPxHiddenField>
    ...
    <script>
        ...
        function OnToolbarItemClick(s, e) {
            if (e.item.name == "EliminarDimension") {
                visibleIndex = gridDimensiones.GetFocusedRowIndex();
                gridDimensiones.GetRowValues(visibleIndex, 'OIDDimension;Activo', fncEliminarDimension);
            }
        }

        function fncEliminarDimension(value) {
            var OIDDimension = value[0];

            if (OIDDimension != 0) {
                hiddenDimensionID.Set("OIDDimension", OIDDimension);
                PopupEliminarDimension.Show();
            } else {
                PopupError.Show();
            }
        }
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 class="m-0" style="padding-top:15px;"><b>Dimensiones</b></h3>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right"style=" padding-top:15px">
              ...
              <li class="breadcrumb-item active"style="color:white">Dimensiones</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <dx:ASPxGridView
        ID="gridDimensiones"
        ClientInstanceName="gridDimensiones"
        runat="server"
        AutoGenerateColumns="False"
        DataSourceID="SqlDSDimensiones"
        KeyFieldName="OIDDimension"
        Width="100%" 
        OnInitNewRow="gridDimensiones_InitNewRow">
        ...
        <Columns>
            <dx:GridViewDataTextColumn VisibleIndex="0" FieldName="OIDDimension" ReadOnly="True" Caption="OIDDimension" Visible="False">
            ...
            <dx:GridViewDataMemoColumn FieldName="Descripcion" Caption="Descripci&#243;n" VisibleIndex="1">
                <PropertiesMemoEdit MaxLength="200" Rows="5">
                    <ValidationSettings ErrorDisplayMode="ImageWithTooltip" ErrorTextPosition="Right" RequiredField-IsRequired="true" 
                                        RequiredField-ErrorText="Ingresar dimensión." ValidateOnLeave="true" SetFocusOnError="true">
                        <RequiredField IsRequired="True" ErrorText="Ingresar dimensión."></RequiredField>
                    </ValidationSettings>
                </PropertiesMemoEdit>
        ...
        <Toolbars>
            <dx:GridViewToolbar ItemAlign="Right">
                <Items>
                    ...
                    <dx:GridViewToolbarItem Text="Eliminar" Name="EliminarDimension" BeginGroup="True">
    ...
    <!-- POPUP ELIMINAR -->
    <dx:ASPxPopupControl
        ID="PopupEliminarDimension"
        ClientInstanceName="PopupEliminarDimension"
        runat="server"
        Modal="True"
        ...
        <ContentCollection>
            <dx:PopupControlContentControl>
                ...
                <div class="text-right">
                    <dx:ASPxButton ID="btnEliminarDimension" OnClick="btnEliminarDimension_Click" runat="server" Text="Eliminar" BackColor="#FF3547" CssClass="btn-danger">
                    ...
                    <dx:ASPxButton ID="btnCerrarEliminar" runat="server" Text="Cancelar" AutoPostBack="false" BackColor="White" ForeColor="#FF3547" CssClass="btn-danger">
                        <ClientSideEvents Click="function (s, e) { PopupEliminarDimension.Hide(); }" />
                        <Border BorderColor="#FF3547" BorderStyle="Solid" BorderWidth="3px" />
                    </dx:ASPxButton>
                </div>
            </dx:PopupControlContentControl>
    ...
    <!-- SQLDS DIMENSIONES -->
    <asp:SqlDataSource ID="SqlDSDimensiones" runat="server" ConnectionString='<%$ ConnectionStrings:NOM035ConnectionString %>' SelectCommand="spListadoNOMEncuestasDimensiones"
        InsertCommand="spCrearNOMEncuestasDimensiones"
        UpdateCommand="spActualizarNOMEncuestasDimensiones" InsertCommandType="StoredProcedure" SelectCommandType="StoredProcedure" UpdateCommandType="StoredProcedure">
        <InsertParameters>
        ...
        <UpdateParameters>
            <asp:Parameter Name="Descripcion" Type="String"></asp:Parameter>
            <asp:Parameter Name="Activo"></asp:Parameter>
            <asp:Parameter Name="OIDDimension" Type="Int64"></asp:Parameter>
        </UpdateParameters>
    </asp:SqlDataSource>
