<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Detalle-informe-I.aspx.cs" Inherits="CreandoProductividad.Panel.Setalle_informe_I" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h3 class="m-0"  style="padding-top: 15px;font-weight:600">Resultados a Detalle Guía I</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right" style="padding-top: 15px">
                        ...
                        <li class="breadcrumb-item active" style="color: white">Detalle Guía I</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <br />
    <a class="btn btn-primary" data-toggle="tooltip" title="Más información"  href="/manual-usuario/Cuestionarios/reportes.html#DetalleguiaI"><i class="fas fa-question-circle" style="color:white; font-size:25px"></i></a>
    <br />
    <dx:ASPxGridView ID="gridDetalle" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDSDetalle" Width="100%">
        ...
        <Columns>
            <dx:GridViewDataTextColumn FieldName="CentroDeTrabajo" VisibleIndex="0">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="ActPrincipoal" VisibleIndex="1">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="NumEncuesta" VisibleIndex="2">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="Guia" VisibleIndex="3">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="Categoria" VisibleIndex="4">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="Dominio" VisibleIndex="5">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="Dimension" VisibleIndex="6">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="Pregunta" VisibleIndex="7">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="Respuesta" VisibleIndex="8" ReadOnly="True">
            </dx:GridViewDataTextColumn>
        </Columns>
        <Styles>
    ...
    <asp:SqlDataSource ID="SqlDSDetalle" runat="server" ConnectionString="<%$ ConnectionStrings:NOM035ConnectionString %>" SelectCommand="SELECT [NombreUnidad] as CentroDeTrabajo
      ...
      Case  
		...
		WHEN ValorRespuesta = 1 THEN 'Casi Nunca' 
		WHEN ValorRespuesta = 2 THEN 'Algunas Veces' 
		WHEN ValorRespuesta = 3 THEN 'Casi Siempre' 
		WHEN ValorRespuesta = 4 THEN 'Siempre' 
		END as Respuesta
  FROM [NOM035].[dbo].[VistaOpeNOMRespuestas]
  Where OIDEmpresa = @OIDEmpresa and OIDGuia = 1">
        <SelectParameters>
