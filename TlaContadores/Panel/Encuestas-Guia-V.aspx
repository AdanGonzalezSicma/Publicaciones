<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Encuestas-Guia-V.aspx.cs" Inherits="CreandoProductividad.Panel.Encuestas_Guia_V" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h3 class="m-0"  style="padding-top: 15px;font-weight:600">Encuestas Guía V</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right" style="padding-top: 15px">
                        ...
                        <li class="breadcrumb-item active" style="color: white">Encuestas Guía V</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <br />
    <a class="btn btn-primary" data-toggle="tooltip" title="Más información"  href="/manual-usuario/Cuestionarios/reportes.html#guiaV"><i class="fas fa-question-circle" style="color:white; font-size:25px"></i></a>
    <br />
    <dx:ASPxGridView
        ID="gridEncuestas"
...
on Encuestas.NumEncuesta = Avance.NumEncuesta
 WHERE ([OIDEmpresa] = @OIDEmpresa) and (avance.GuiaV = 'Completo') ORDER BY Encuestas.[OIDEncuesta] DESC"
 ...
 WHERE OIDEncuesta = @OIDEncuesta">
        ...
        <UpdateParameters>
            ...
            <asp:Parameter Name="OIDEncuesta" />
        </UpdateParameters>
    </asp:SqlDataSource>
