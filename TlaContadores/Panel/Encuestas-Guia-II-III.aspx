<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Encuestas-Guia-II-III.aspx.cs" Inherits="CreandoProductividad.Panel.Encuestas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h3 class="m-0"  style="padding-top: 15px;font-weight:600">Encuestas Guías II y III</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right" style="padding-top: 15px">
                        ...
                        <li class="breadcrumb-item active" style="color: white">Encuestas Guías II y III</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <br />
    <a class="btn btn-primary" data-toggle="tooltip" title="Más información"  href="/manual-usuario/Cuestionarios/reportes.html#guiaII"><i class="fas fa-question-circle" style="color:white; font-size:25px"></i></a>
    <br />
    <dx:ASPxGridView
        ID="gridEncuestas"
        ...
        <SettingsPopup>
            <EditForm HorizontalAlign="WindowCenter" Modal="True" ShowShadow="True" VerticalAlign="WindowCenter" AllowResize="True" MinWidth="50%" Width="50%">
        ...
        <Toolbars>
            <dx:GridViewToolbar ItemAlign="Right" Name="toolbarEncuestas">
                <Items>
                    ...
                    <dx:GridViewToolbarItem BeginGroup="True" Name="respuestas" Text="Reporte de Respuestas" ToolTip="Abre una pestaña con el reporte de respuestas de la encuesta seleccionada">
                    ...
                    <dx:GridViewToolbarItem Name="GenerarReportes" BeginGroup="True" Text="Descargar Todos los Reportes" ToolTip="Descarga los reportes de  guía y respuestas de las encuestas seleccionadas">
...
on Encuestas.NumEncuesta = Avance.NumEncuesta
 WHERE ([OIDEmpresa] = @OIDEmpresa) and (avance.GuiaII = 'Completo' or avance.GuiaIII = 'Completo')  and (avance.GuiaV = 'Completo')  ORDER BY Encuestas.[OIDEncuesta] DESC"
