<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Observacion-Categorias.aspx.cs" Inherits="CreandoProductividad.Observaciones.Observacion_Categorias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  cursor: pointer;
    ...
    <script>
        ...
        var visibleIndex;
        function toltipsCategoria(s, e) {
            if (e.item.name == "eliminar") {
                console.log('Eliminar');
                visibleIndex = gridObservacionesCategoria.GetFocusedRowIndex();
                if (visibleIndex > -1) {
                gridObservacionesCategoria.GetRowValues(visibleIndex, 'OIDObservaciones', fncEliminarCategoria);
                }
            }
        }
        ...
        function fncEliminarCategoria(value) {
            ...
            if (OIDObservacion != 0) {
                ...
                PopupEliminarObservacionCategoria.Show();
            }
        }

        function FunEliminarCategoria() {
            console.log(visibleIndex)
            gridObservacionesCategoria.DeleteRow(visibleIndex);
            PopupEliminarObservacionCategoria.Hide();
        }

        function FunCancelarCategoria() {
            PopupEliminarObservacionCategoria.Hide();
        }
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h3 class="m-0" style="padding-top: 15px;font-weight:600">Observación por Categoría</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right" style="padding-top: 15px">
                        ...
                        <li class="breadcrumb-item active" style="color: white">Observación por Categoría</li>
                    </ol>
                </div>
            </div>
        </div>
   ...
   <a class="btn btn-primary" data-toggle="tooltip" title="Más información"><i class="fas fa-question-circle" style="color:white; font-size:25px"></i></a>
    ...
    <dx:ASPxGridView ID="gridObservacionesCategoria" ClientInstanceName="gridObservacionesCategoria" runat="server" AutoGenerateColumns="False" DataSourceID="sqlObservacionesCategorias" KeyFieldName="OIDObservaciones" Width="100%">
        <ClientSideEvents ToolbarItemClick="toltipsCategoria"></ClientSideEvents>
        ...
        <EditFormLayoutProperties ColCount="2" ColumnCount="2">
            <Items>
                <dx:GridViewColumnLayoutItem ColumnName="DescripcionObservacion" ColSpan="2" ColumnSpan="2"></dx:GridViewColumnLayoutItem>
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="OIDCategoria" VisibleIndex="4" Visible="False"></dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="DescripcionObservacion" VisibleIndex="5"></dx:GridViewDataTextColumn>
        </Columns>
        <Toolbars>
            <dx:GridViewToolbar ItemAlign="Right"  Name="toolbarObserCategoria">
                <Items>
    ...
    <dx:ASPxPopupControl ID="PopupEliminarObservacionCategoria" ClientInstanceName="PopupEliminarObservacionCategoria" runat="server"
        ...
        <ContentCollection>
            <dx:PopupControlContentControl>
                ...
                <div class="text-right">
                    <button class=" btn btn-danger" id="btnEliminarCategoria" onclick="FunEliminarCategoria()" type="button"style="background-color:#FF3547; border:1px solid #FF3547; color:#FFFFFF">
                        ELIMINAR
                    </button>
                    <button class=" btn btn-danger" id="btnCancelarCategoria" onclick="FunCancelarCategoria()" type="button" style="background-color:white; border:2px solid #FF3547; color:#FF3547">
                        CANCELAR
                    </button>
                </div>
            </dx:PopupControlContentControl>
    ...
    <asp:SqlDataSource ID="sqlObservacionesCategorias" runat="server" ConnectionString='<%$ ConnectionStrings:NOM035ConnectionString %>' SelectCommand="SELECT OIDObservaciones, Fecha, OIDEmpresa, OIDCategoria, DescripcionObservacion FROM CatNOMObservacionesCategorias WHERE (OIDEmpresa = @OIDEmpresa) ORDER BY OIDObservaciones DESC" DeleteCommand="DELETE FROM [NOM035].[dbo].[CatNOMObservacionesCategorias]
    WHERE [OIDObservaciones] = @OIDObservaciones"
        UpdateCommand="UPDATE [NOM035].[dbo].[CatNOMObservacionesCategorias]
   SET  [DescripcionObservacion] = @DescripcionObservacion
 WHERE [OIDObservaciones] = @OIDObservaciones">
        <DeleteParameters>
        ...
        <UpdateParameters>
            <asp:Parameter Name="DescripcionObservacion"></asp:Parameter>
            <asp:Parameter Name="OIDObservaciones"></asp:Parameter>
        </UpdateParameters>
    </asp:SqlDataSource>
