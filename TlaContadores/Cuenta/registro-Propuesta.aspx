<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registro-Propuesta.aspx.cs" Inherits="CreandoProductividad.Cuenta.registro_Propuesta" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="formulario">
                                ...
                                <div class="mb-3 mt-3">
                                     <div class="form-group element">
                                        <input id="txtConfirmar" runat="server" class="form-control" placeholder="Confirmar contraseña" autocomplete="off" name="txtPassword" type="password" />
                                        <i class="fa fa-eye-slash fs-5 showpwd" onclick="showPwd('txtConfirmar', this)" id="showpwd2" style="color: #a1a5b7;"></i>
                                    </div>
                                ...
                                <button type="submit" class="btn btn-primary" style="width: 100%">Registrate</button>
                                <br />
                                <br />
                                <div class="text-center ">
                                    <a></a>
