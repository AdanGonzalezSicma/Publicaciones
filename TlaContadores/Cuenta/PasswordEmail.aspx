<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PasswordEmail.aspx.cs" Inherits="CreandoProductividad.Cuenta.PasswordEmail" %>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <form class=" validate-form">
                            <br />
                            <h1 id="titulo" class="login100-form-title" style="font-size: 30px;">Se ha enviado un correo con las instrucciones para continuar con la recuperación de tu contraseña
                            </h1>

                            <div class="container-login100-form-btn">
                                <a href="/index.html" class="login100-form-btn" id="btnLogin">
