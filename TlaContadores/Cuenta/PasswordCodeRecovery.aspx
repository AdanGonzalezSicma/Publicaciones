<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PasswordCodeRecovery.aspx.cs" Inherits="CreandoProductividad.Cuenta.PasswordCodeRecovery" %>
...
<body style="background-color: #666666;">
            ...
            <div id="borderraibown" class="wrap-login100 borderraibown" style="border-top: 15px solid;  box-shadow: 0 1rem 3rem rgba(0, 0, 0, 0.175) !important;">
                ...
                <form id="form1" runat="server" class="login100-form validate-form">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="El correo no puede estar vacío">
                        <asp:TextBox ID="txtUsuario" TextMode="Password" class="input100" runat="server" placeholder="Contraseña"></asp:TextBox>
                    ...
                    <div class="wrap-input100 validate-input" data-validate="El correo no puede estar vacío">
                        <asp:TextBox ID="txtUsuarioConfirm" TextMode="Password" class="input100" runat="server" placeholder="Confirma Contraseña"></asp:TextBox>
                         <span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-lock" aria-hidden="true"></i>
						</span>
                    ...
                    <div class="container-login100-form-btn">
                        <asp:Button ID="btnLogin" runat="server" Text="Cambiar Contraseña" class="login100-form-btn" OnClick="btnLogin_Click"/>
                    </div>
                    <br />
                    <br />
    ...
    <!--====-->
    <script src="vendor/countdowntime/countdowntime.min.js"></script>
    <!--====-->
